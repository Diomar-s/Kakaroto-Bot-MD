...
╭┄─🐉⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪𝕂𝔸𝕂𝔸ℝ𝕆𝕋𝕆໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪╯
│
├ ⚘݄𖠵⃕⁖𖥔. _*𝕋í𝕥𝕦𝕝𝕠*_
├» ${yt_play[0].title}
├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┄
...
await conn.sendButton(m.chat, wm, texto1, yt_play[0].thumbnail, [['𝕄𝔼ℕ𝕌 ☁️', `${usedPrefix}menu`],['🐉 𝔸𝕌𝔻𝕀𝕆',`${usedPrefix}play5 ${yt_play[0].url}`],['💨 𝕍𝕀𝔻𝔼𝕆',`${usedPrefix}play6 ${yt_play[0].url}`]], null, null, fgif2)
} catch (e) {
