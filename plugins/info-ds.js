...
if (filesDeleted === 0) {
await conn.reply(m.chat, '☁️ *No se encontró ningún archivo que incluya la ID del chat*', m, rcanal, )
} else {
...
await conn.reply(m.chat, '[🐉] *Hola Soy Kakaroto Sigue El Canal y apoyanos porfa*', m, rcanal, )
}
