...
if (code !== DisconnectReason.connectionClosed) { parent.sendMessage(m.chat, { text: "🚩 Conexión perdida con el servidor vuelva a perdir code." }, { quoted: m });
}}
