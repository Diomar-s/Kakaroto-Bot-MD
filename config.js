...
global.owner = [
  ['573138954963', '💨 Kakaroto-Bot', true],
  ['573142051545', '✨ 𝗖𝗿𝗲𝗮𝗱𝗼𝗿 Legendary', true],
  
];

//• ↳𝑺𝑶𝑳𝑶 𝑴𝑶𝑫𝑬𝑹𝑨𝑫𝑶𝑹𝑬𝑺!
global.mods = ['573142051545', '573142051545', '', '', '']

global.suittag = ['573142051545']
global.prems = []
...
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packsticker = `♾ ━━━━━━━━\n├ ɓσƭ:\n├ ρяοριєταяιο:\n├ ƒєϲнα ∂є ϲяєαϲιόи:\n├ нοяα:\n♾━━━━━━━━`
global.packname = `💨⭑Kakaroto-Bot⭑(^_^♪)`
global.author = `♾━━━━━━━━\n⇝͟͞ KᗩKᗩᖇOTO-ᗷOT   ᷨᜳ ͦ ̵ͭ⋆\n⇝ ۵-̱̅𝐃𝖆𝒗𝖏𝖉𐝃𐋃ᑎ̃ᗴᘜᗴᑎᗪᗩᖇY-͞ˍ\n⇝ ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_Angeles').format('HH:mm:ss')} \n♾━━━━━━━━\n\n\n\nѕτιϲκєя ϐγ: ৎKᗩKᗩᖇOTO-ᗷOT🔥̤ʙⷪᴏ͓ᷫᴛⷭ𓆪͟͞ `;
global.wm = 'ৎKᗩKᗩᖇOTO🔥̤ʙⷪᴏ͓ᷫᴛⷭ𓆪͟͞ ';
global.titulowm = '͟͞ ৎKᗩKᗩᖇOTO-ᗷOT🔥̤𓆪 ͟͞';
global.titulowm2 = `͟͞ ৎKᗩKᗩᖇOTO-Oᖴᑕ🔥̤𓆪 ͟͞`
global.igfg = '☆꧁༒ĹєǤ𝒆𝐧𝐃༒꧂'
global.botname = 'KᗩKᗩᖇOTO-ᗷOT'
global.dev = '🔥 Powered By ᒪᗴᘜᗴᑎᗪᗩᖇY Team ⚡︎'
global.textbot = 'KᗩKᗩᖇOTO-ᗷOT࿐ : ☆꧁༒ĹєǤ𝒆𝐧𝐃༒꧂☆'
global.gt = '͟͞ ৎ୭࠭͢💨𝑬̶ՏᗩYᗩYIᑎ😓𓆪 ͟͞';
global.namechannel = '⏤͟͞KᗩKᗩᖇOTO࿐/☆꧁༒ĹєǤ𝒆𝐧𝐃༒꧂☆'
global.vs = '3.0.2'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '⏤͟͞KᗩKᗩᖇOTO࿐', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
...
global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Kakaroto', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵⃕⁖𝐒𝐭𝐢𝐜𝐤𝐞𝐫 (^_^♪) 💥', jpegThumbnail: logo5 }}};

global.fgif2 = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`͟͞ ☆꧁༒ĹєǤ𝒆𝐧𝐃༒꧂☆`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `KᗩKᗩᖇOTO࿐\n  ͟͞ 𓆩ꪶꪾ☆꧁༒ĹєǤ𝒆𝐧𝐃༒꧂☆࠱࠭ ͟͞`, 'jpegThumbnail': logo4 }}}

//• ↳ ◜𝑳𝑰𝑵𝑲𝑺◞ • 🌿
global.gp4 = 'https://whatsapp.com/channel/0029VagYdbFEwEk5htUejk0t' //Grupo Oficial De Megumin
